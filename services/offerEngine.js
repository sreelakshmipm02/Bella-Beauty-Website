...
export const getBestOfferForTarget = ({
  productId,
  categoryId,
  basePrice,
  offers = [],
  ...
  for (const offer of offers) {
    const targetIdString =
      offer.targetId?.toString?.() || String(offer.targetId || "");
    const matchesProduct =
      offer.offerType === "product" && targetIdString === productIdString;
    const matchesCategory =
      offer.offerType === "category" && targetIdString === categoryIdString;
